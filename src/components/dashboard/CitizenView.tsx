import { MapPin, Wind, Info, Droplets, Sun, Activity, ChevronRight, X, Play, Square, Star, Shield, Map as MapIcon, CheckCircle2 } from 'lucide-react'
    ...
    <>
      ...
      >
          ...
          <div className="flex items-center justify-between mb-6 relative z-10 bg-white/5 p-4 rounded-2xl border border-white/5">
            <div>
               ...
               <div className="flex items-center gap-2 text-xs text-zinc-400">
                  ...
                  <span>{dbUser.xp || 0} XP • {dbUser.badges?.[dbUser.badges.length - 1] || 'Scout'}</span>
               </div>
            </div>
        ...
        <button 
           onClick={() => {
              if (userLocation) {
                 // Mocking finding the nearest clean zone
                 setGreenDestination([userLocation[0] - 0.03, userLocation[1] + 0.02])
              }
           }}
        ...
        >
           <div className="flex items-center gap-2">
             ...
             <span>Find Nearest Clean Zone</span>
           </div>
